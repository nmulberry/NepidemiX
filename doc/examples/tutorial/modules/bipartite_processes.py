...
class BipartiteSALTSProcess(BipartiteStateProcess):
    """
    S A L T S process on Bipartite network
    ...
    """
    def __init__(self, beta, eta, gamma_a, gamma_b, mu_a, mu_b, tau, c, delta, alpha):

        super(BipartiteSALTSProcess, self).__init__(['SA', 'AA', 'LA', 'TA', 'SB', 'AB', 'LB', 'TB'],
                                         [],
                                         runNodeUpdate = True,
                                         runEdgeUpdate = False,
                                         runNetworkUpdate = False,
...
class BipartiteSALTSProcessVac(BipartiteStateProcess):
    """
    ...
    def __init__(self, beta, eta, gamma_a, gamma_b, mu_a, mu_b, tau, c, delta, alpha, nu_a, nu_b):
        ...
        super(BipartiteSALTSProcessVac, self).__init__(['VA','VB','SA', 'AA', 'LA', 'TA', 'SB', 'AB', 'LB', 'TB'],
                                         [],
                                         runNodeUpdate = True,
                                         runEdgeUpdate = False,
                                         runNetworkUpdate = False,
